<x-app-layout>
    <x-slot name="header">Edit Divisi — {{ $divisi->name }}</x-slot>
    ...
    <div class="max-w-lg">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <form method="POST" action="{{ route('divisi.update', $divisi) }}" class="space-y-4">
                @csrf @method('PUT')

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Nama Divisi</label>
                    <input type="text" name="name" value="{{ old('name', $divisi->name) }}"
                ...
                <div>
                    ...
                    <input type="text" name="code" value="{{ old('code', $divisi->code) }}"
                ...
                <div class="flex items-center gap-2">
                    ...
                    <label for="is_active" class="text-sm font-medium text-gray-700">Divisi Aktif</label>
                </div>
